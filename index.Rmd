...
## III. Shiny App: What do I see here? 
...
#### - **Components of the App**:
  ...
  - **The Lockdown Dates Dataset**: [documentation](https://auravision.ai/covid19-lockdown-tracker/)
...
#### - **The Website**:
  ...
  - Finally, to create a server for our dynamic website, we use the *`shinyapps.io'*, which offers free servers for Shiny-embedded .Rmd file.   
...
#### Here we analyze the changes in four search terms. In doing so, we show how results vary based on the state of interest. See how patterns differ across <span style="color: red;">Red</span> and <span style="color: blue;">Blue</span> states! 

### Search Term 1: Nintendo Switch

### Search Term 2: Sourdough

### Search Term 3: Fireguns

### Search Term 4: Vote-in-Mail
