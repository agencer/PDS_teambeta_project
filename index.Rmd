...
#### Here we analyze the changes in four search terms. In doing so, we show how results vary based on the state of interest. See how patterns differ across <span style="color: blue;">Blue</span> (New York and California),  <span style="color: black;">Competitive</span> (Florida and Minnesota), and  <span style="color: red;">Red</span> (Texas and Georgia) states! 
...
```{r Nintendo Switch, echo= F, include=T,  fig.align = "center", fig.cap = "The Search Trend of Nintendo Switch Across States"}
for(i in 1:6){
...
```{r Sourdough, echo= F, include=T,  fig.align = "center", fig.cap = "The Search Trend of Sourdough Across States"}
for(i in 1:6){
...
### Search Cluster 2: Terms on Wane After Lockdowns 

```{r Cheap Tickets, echo= F, include=T,  fig.align = "center", fig.cap = "The Search Trend of Cheap Tickets Across States"}
for(i in 1:6){
...
```{r basketball, echo= F, include=T,  fig.align = "center", fig.cap = "The Search Trend of Basketball Across States"}
for(i in 1:6){
...
```{r Child Care, echo= F, include=T,  fig.align = "center", fig.cap = "The Search Trend of Child Care Across States"}
for(i in 1:6){
  assign(paste0(my.states[i]), my.fun2(vector.keyword = "Child Care", state.abbr = paste0("US-", my.states[i])))
}
grid.arrange(NY, CA, FL, MN, TX, GA)
```
...
```{r businesses, echo= F, include=T,  fig.align = "center", fig.cap = "The Search Trend of Businesses Across States"}
for(i in 1:6){
...
```{r Mask, echo= F, include=T,  fig.align = "center", fig.cap = "The Search Trend of Face Mask Across States"}
for(i in 1:6){
...
```{r Protests, echo= F, include=T,  fig.align = "center", fig.cap = "The Search Trend of Protest Across States"}
for(i in 1:6){
...
```{r Guns, echo= F, include=T,  fig.align = "center", fig.cap = "The Search Trend of Guns Across States"}
for(i in 1:6){
  assign(paste0(my.states[i]), my.fun2(vector.keyword = "guns", state.abbr = paste0("US-", my.states[i])))
}
grid.arrange(NY, CA, FL, MN, TX, GA)
```
